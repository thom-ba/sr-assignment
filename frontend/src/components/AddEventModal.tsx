import React, { FormEvent, useMemo, useReducer, useState } from "react";
import { AppEvent, Category, Competition, Sport, Team, Venue } from "../types";
...
export const AddModalEvent: React.FC<AddEventModalProps> = ({
    onClose,
    onAddEvent,
    onAddSport,
    onAddCategory,
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        try {
            const newEvent = await saveEvent(eventToCreate);
            onAddEvent(newEvent);
            dispatch({ type: 'RESET' });
            onClose();
        } catch (error) {
                                        ...
                                        <div className="bg-gray-700 px-2 rounded-lg border border-gray-600">
                                            ...
                                            <div className="flex justify-end gap-2 pb-1">
                                                <Button
                                                    ...
                                                    type="button"
                                                    size="small"
                                                    onClick={() => setStep1View("addCompetition")}
                                                >
                                                    Back
                                                </Button>
                                                <Button
                                        ...
                                        <div className="bg-gray-700 px-4 py-4 rounded-lg border border-gray-400 mt-4">
                                            ...
                                            <div className="flex justify-end gap-2 pb-1">
                                                ...
                                                <Button
                                                    ...
                                                    variant="primary"
                                                    size="small"
                                                    onClickCapture={handleSaveNewCategory}
                                                >
                                                    Save Category
                                                </Button>
                                            </div>
                                    ...
                                    return (
                                        <div className="pt-4">
                                            <div className="bg-gray-700 px-4 py-4 rounded-lg border border-gray-400">
                                                <h3 className="pb-3">Create a New Competition</h3>
                                                <Input
                                                    id="newCompetition"
                                                    name="newCompetition"
                                                ...
                                                <div className="pt-4">
                                                    <div className="flex justify-between items-center">
                                                        ...
                                                        <button
                                                            type="button"
                                                            onClick={() => setStep1View("addCategory")}
                                                ...
                                                <div className="pt-4">
                                                    <Input
                                                        id="newCompetitionYear"
                                                        name="year"
                                                        label="Year"
                                                        value={newCompetitionData.year}
                                                        onChange={(e) =>
                                                            setNewCompetitionData((n) => ({
                                                                ...n,
                                                                year: e.target.value,
                                                ...
                                                <div className="max-h-32 overflow-y-auto border border-gray-600 bg-gray-600">
                                                    {sports
                                                        .filter((sport) =>
                                                            sport.name
                                                                ?.toLowerCase()
                                                                .includes(sportSearchTerm.toLowerCase()),
                                                        )
                                                        .map((sport) => (
                                                            <button
                                                                key={sport.id}
                                                ...
                                                <div className="flex justify-end gap-2">
                                                    ...
                                                    <Button
                                                        type="button"
                                                        variant="primary"
                                                        onClick={() => handleSaveNewCompetition()}
                                                    >
                                                        Save Competition
                                                    </Button>
                                                </div>
                                        ...
                                        <div className="bg-gray-700 px-4 py-4 rounded-lg border border-gray-400 mt-2">
                                            ...
                                            <div>
                                                <Input
                                                    ...
                                                    onChange={(e) =>
                                                        setCompetitionSearchTerm(e.target.value)
                                                    }
                        ...
                        {(() => {
                            switch (step1View) {
                                case "addVenue":
                                    return (
                                        <div className="bg-gray-700 px-4 py-4 rounded-lg border border-gray-400 mt-4">
                                            <h2 className="text-lg font-md text-white pb-2">
                                                Create a New Venue
                                            </h2>
                                            <Input
                                                id="newVenueName"
